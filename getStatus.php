<?php
    ...
    if (preg_match('/\bActive: active\b/', $output)){
        ...
        echo "<div class='start'><form method='post'><input type='button' class='btn btn-info' value='Show console' name='showConsole'></input> <input type='button' class='btn btn-danger' value='Stop serve' name='stopServer'></input></form></div>";
    }
