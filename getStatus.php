<?php
    ...
    if (preg_match('/\bActive: active\b/', $output)){
        ...
        echo "<div class='start'><form method='post'><input type='button' class='btn btn-info' value='Show console' name='showConsole'></input><input type='button' class='btn btn-danger' value='Stop serve' name='stopServer'>r</input></form></div>";
    }
    else if (preg_match('/\bActive: inactive\b/', $output)){
        $val = "Not running";
        echo "<div class='status'>Status: <b style='color: red;'>$val</b></div>";
        echo "<div class='start'><form method='post'><input type='button' class='btn btn-primary' value='Start server' name='startServer'></input></form></div>";
    }
    else{
        $val = "Error";
        echo "<div class='status'>Status: <b style='color: red;'>$val</b></div>";
